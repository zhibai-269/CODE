...
%         ??????
        ...
        if ~isempty(f_indx_1)
            ...
            for seg_id = 2:size(fiber_end_1,2)
                ...
                seg_v1.x = fiber_end_1(1,seg_id);seg_v1.y = fiber_end_1(2,seg_id);seg_v1.z = fiber_end_1(3,seg_id);
                seg_v2.x = fiber_end_1(1,seg_id-1);seg_v2.y = fiber_end_1(2,seg_id-1);seg_v2.z = fiber_end_1(3,seg_id-1);
